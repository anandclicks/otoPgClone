...
const GreaterNoida = () => {
  ...
  return (
    <>
      <HeaderTwo activeLink={"Greater Noida"} />
      <GetCallForm/>
          ...
          <div className="pgsWrapper">
            ...
            <div className="headingRow">
              <div className="quickLinks">
                <Link to={'/'}><span>Home<i className="ri-arrow-drop-right-line"></i></span></Link>Greater Noida
              </div>
              <h3 className="noidaAllPgHeading">
                Showing properties in <span>Greater Noida</span>
              </h3>
            </div>
            {/* all cards */}
